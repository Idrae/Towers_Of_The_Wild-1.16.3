...
public class DerelictGrassTowerPools {
    ...
    public static JigsawPattern BOTTOM = JigsawRegistration.register(
            new JigsawPattern(
                    new ResourceLocation(TowersOfTheWild.MOD_ID, "derelict_grass_bottom"),
    ...
    public static JigsawPattern TOP =
            new JigsawPattern(
                    new ResourceLocation(TowersOfTheWild.MOD_ID, "derelict_grass_top"),
                    new ResourceLocation("empty"),
                    ImmutableList.of(
                            Pair.of(JigsawPiece.func_242851_a(
                                    ModList.get().isLoaded("waystones") && TowersOfTheWildConfig.waystonesCompat ?
                                            TowersOfTheWild.MOD_ID + ":derelict_grass/waystone_derelict_grass_tower_top" :
